-- =============================================================================
-- SupersDeck — Backlog (discretionary jobs to hand handymen on slow days)
-- =============================================================================
-- A lightweight task queue, kept SEPARATE from work_orders (which are reactive
-- tenant tickets). Tasks live in "folders" (Cabinets, Painting, …) and can sit
-- pending indefinitely until assigned. Attachments (photos, scanned work
-- orders, PDFs) go in a private `task-files` bucket.
--
-- Run once in the Supabase SQL editor, after role-policies.sql + storage-setup.sql.
-- =============================================================================
