...
export interface WorkOrderPrintSheetProps {
  ...
  /** Footer attribution, e.g. "Generated by SupersDeck". Hidden if omitted. */
  poweredBy?: string;
}

export function WorkOrderPrintSheet({ wo, poweredBy }: WorkOrderPrintSheetProps) {
    ...
    <div className="mx-auto max-w-[8.5in] bg-white p-6 text-black print:p-0">
      ...
      <div className="border border-zinc-300 p-8 print:border-0 print:p-0">
        ...
        <section className="mb-5 grid grid-cols-2 gap-x-8 gap-y-2 text-sm md:grid-cols-3">
          ...
          <Meta label="Source" value={wo.source ? cap(wo.source) : "—"} />
        </section>
        ...
        <footer className="mt-6 border-t border-zinc-300 pt-2 text-center text-[10px] text-zinc-500">
          {wo.org.name} · Completed{" "}
